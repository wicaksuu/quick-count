<div>
    ...
    <li>
        ...
        <ul>
            <li>
                ...
                <ul>
                        @foreach ($partais as $partai)
                            <li>
                                <a href="{{ route('setting-calon-gubernur',['id'=>$partai->id]) }}" class="pl-14 pr-4 py-2 block text-[13.5px] font-medium text-gray-700 transition-all duration-150 ease-linear hover:text-violet-500 dark:text-gray-300 dark:active:text-white dark:hover:text-white">
                                    {{ $partai->nama }}
                                </a>
                            </li>
                        @endforeach
            ...
            <li>
                <a href="{{ route('setting-gubernur') }}"
                    class="pl-14 pr-4 py-2 block text-[13.5px] font-medium @if (Route::currentRouteName() == 'setting-gubernur') text-blue-700 dark:text-blue-300 @else text-gray-700 dark:text-gray-300 @endif transition-all duration-150 ease-linear hover:text-violet-500 dark:active:text-white dark:hover:text-white">
                    Setting Dapil
                </a>
            </li>
        </ul>
